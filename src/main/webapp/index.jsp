...
%>
		...
		<div id="page">
			...
			<div id="theSidebarWrapper" class="sidebarWrapper" onmouseover="resizeSidebar()">
				...
				<div id="sidebar">
					<ul>
					<jsp:include page='index/adminMenu.jsp'/>
					<div id="scoreboardButton" style="display: none">
		...
		<script>
			function shouldWeShowTheScoreboardButton(){
				var ajaxCall = $.ajax({
					type: "GET",
					url: "api/scoreboard",
					async: false
				...
				{
					$("#scoreboardButton").fadeIn("slow");
				}
				else
				{
					$("#scoreboardButton").slideUp("fast");
				}
			}
			
			function shouldWeShowTheCheatButton(){
				var ajaxCall = $.ajax({
					type: "GET",
					url: "api/cheats",
					async: false
				...
				if(ajaxCall.status == 200)
				{
					$("#cheatSheetButton").fadeIn("slow");
				}
				else
				{
					$("#cheatSheetButton").slideUp("fast");
				}
			}
			
			shouldWeShowTheScoreboardButton();
